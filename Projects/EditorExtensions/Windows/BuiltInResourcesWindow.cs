...
namespace EditorExtensions.Windows
{
    public class BuiltInResourcesWindow : EditorWindow
    {
        ...
        {
            BuiltInResourcesWindow w = EditorWindow.GetWindow<BuiltInResourcesWindow>();
            w.Show();
        }
            ...
            if (_drawings == null)
            {
                ...
                else if (_showingIcons)
                {
                    if (_objects == null)
                    {
                        ...
                        _objects.Sort((pA, pB) => String.Compare(pA.name, pB.name, System.StringComparison.OrdinalIgnoreCase));
                    }
