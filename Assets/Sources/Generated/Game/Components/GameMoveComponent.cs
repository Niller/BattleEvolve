...
public partial class GameEntity {
    ...
    public void AddMove(UnityEngine.Vector2 newVelocity, float newCurrentAcceleration) {
        var index = GameComponentsLookup.Move;
        var component = CreateComponent<MoveComponent>(index);
        component.Velocity = newVelocity;
        component.CurrentAcceleration = newCurrentAcceleration;
        AddComponent(index, component);
    }

    public void ReplaceMove(UnityEngine.Vector2 newVelocity, float newCurrentAcceleration) {
        var index = GameComponentsLookup.Move;
        var component = CreateComponent<MoveComponent>(index);
        component.Velocity = newVelocity;
        component.CurrentAcceleration = newCurrentAcceleration;
