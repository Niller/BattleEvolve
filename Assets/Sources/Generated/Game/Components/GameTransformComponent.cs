...
public partial class GameEntity {
    ...
    public void AddTransform(UnityEngine.Vector2 newPosition, float newRotation) {
    ...
    public void ReplaceTransform(UnityEngine.Vector2 newPosition, float newRotation) {
        var index = GameComponentsLookup.Transform;
        var component = CreateComponent<TransformComponent>(index);
        component.Position = newPosition;
        component.Rotation = newRotation;
